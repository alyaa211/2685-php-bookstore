...
<body class="bg-gray-900 text-orange-100">
    ...
    <div>
        ...
        <div class="rounded bg-black text-orange-300 m-4 p-2">
            <img src="<?= $catsApis['image']; ?> " alt="">
            <p><?= $catsApis['name']; ?></p>
            <p>a few information :</p>

            <ul type="sqaure">
                <li><?= $catsApis['orgin']; ?></li>
                <li><?= $catsApis['life-span']; ?></li>
                <li><?= $catsApis['group']; ?></li>
            </ul>

            <p><?= $catsApis['history']; ?></p>
            <hr />
